...
export default function SignUp() {
  ...
  const [userData, setUserData] = useState({ profileImage: '' });
      ...
      <Grid item xs={12} sm={8} md={4} component={Paper} elevation={6} sx={{ borderRadius: 4, marginTop: 15, padding: 4 }}>
        ...
        >
          ...
          <Stack>
            {isLoading ? (
              ...
              <Avatar
                ...
                sx={{ bgcolor: deepPurple[400], width: 80, height: 80 }}
          ...
          <Box component="form" sx={{ mt: 3 }}>
            ...
            {/* Uncomment the button and adjust the logic to enable when data is loaded */}
            {/* <Button
              type="submit"
              fullWidth
              variant="contained"
              sx={{ mt: 3, mb: 2 }}
              disabled={isLoading} // Enable button when not loading
            >
